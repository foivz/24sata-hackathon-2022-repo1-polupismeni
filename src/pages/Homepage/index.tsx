...
import { duration, Grid, Switch, TextField, Dialog, Paper, Box, Button, IconButton, useMediaQuery, GridSize } from '@material-ui/core';
...
const Homepage = () => {
	...
	return (
		<div className='homepage'>
			...
			<Grid container>
				<Grid item xs={colWidth as GridSize}>
				...
				<Grid item xs={colWidth as GridSize} >
					<Grid container alignItems='center' justifyContent='center' style={{ 'padding': '50px' }}>
						...
						<Line type="monotone" dataKey="estSpent" stroke="white" />
						</LineChart>
					</Grid>
				</Grid>
			</Grid>
			<SpeedDial
				...
				sx={{ position: 'absolute', bottom: 20, right: 100, 'height': '100' }}
				icon={<SpeedDialIcon />}
			>
				{actions.map((action) => (
					<SpeedDialAction
							...
							<Grid item xs={12}>
								<Button
									...
									<input
										...
										hidden
										onChange={() => {
											setCurrentExpenseToAdd(loadedPicture);
										}}
									/>
								</Button>
							</Grid>
