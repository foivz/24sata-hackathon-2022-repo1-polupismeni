            ...
            <Grid item xs={4}>
                {mobileMode ?
                        ...
                        >
                             <Paper >
                                <MenuList className="navigation-bar__menu__popover">
                                    ...
                                    <MenuItem style={{'color': '#4E9F3D'}} component={Link} to='/stonks'>Stocks</MenuItem>
                    ...
                    <ButtonGroup variant="outlined" aria-label="text button group" className="navigation-bar__options">
                        ...
                        <Button style={{'color': '#4E9F3D'}} className='navigation-bar__hover-animation' component={Link} to='/stonks'>Stocks</Button>
